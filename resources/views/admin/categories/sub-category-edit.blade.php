...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <form role="form" method="POST" action="{{ route('subcategory-update',['id' => $subcategoryid]) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="category_id" id="category_id" onchange="get_category_type();" style="width: 100%;">
                                        ...
                                        @elseif($subcategory->category_id == $option['id'])
                                        <option value="{{ $option['id'] }}" selected>{{ $option['category_name'] }}</option>
                                        @else
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sub_category_name" id="sub_category" class="form-control" value="@if(old('sub_category_name')) {{ old('sub_category_name') }}@else {{ $subcategory->sub_category_name }}  @endif" id="name" placeholder="Category Name">
