...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <form role="form" method="POST" action="{{ route('store-item') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="sub_category" name="sub_category_id" style="width: 100%;">
                                        ...
                                        @if (old('sub_category_id') == $option['id'])
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_name" class="form-control" value="@if(old('item_name'))  {{ old('item_name') }}  @endif" id="name" placeholder="Item Name">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="item_description" class="form-control" id="name" placeholder="Item Description">@if(old('item_description')){{ old('item_description') }}@endif</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" class="form-control" value="@if(old('price'))  {{ old('price') }}  @endif" id="name" placeholder="Item Price">
                                    @if ($errors->has('price'))
                                    <span class="invalid-feedback msg" role="alert">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" class="form-control" value="@if(old('discount'))  {{ old('discount') }}  @endif" id="name" placeholder="Discount %">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" class="form-control" value="@if(old('quantity'))  {{ old('quantity') }}  @endif" id="quantity" placeholder="Quantity">
